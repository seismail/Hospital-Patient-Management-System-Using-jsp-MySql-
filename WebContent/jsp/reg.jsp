...
<body>
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="reg.jsp">Register</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1><font color="#3A5795"><b>Registration:</b></font></h1><br>
  <form method="post" action="registration.jsp">
    ...
    <input type="submit" name="login" class="login login-submit" value="Submit">
       ...
       <h3><a href="reg.jsp">Already registered!!!</a>  <a href="index.jsp">Login Here</a></h3>

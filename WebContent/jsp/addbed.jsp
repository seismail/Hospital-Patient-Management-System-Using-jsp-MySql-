      ...
      <div id="menubar">
        <ul id="menu">
         ...
         <li><a href="adminindex.jsp">Home</a></li>
          ...
          <li class="selected"><a href="addbed.jsp">Add Bed</a></li>
...
%>
      ...
      <div id="content">
         ...
         <h1><font color="blue">Please Add Bed:</font></h1><br>
  <form method="post" action="bregistration.jsp">
    <input type="text" name="fname" placeholder="Floor Name" required><br><br>
    <input type="text" name="room" placeholder="Room No" required><br><br> 
     <input type="text" name="bed" placeholder="Bed Number" required><br><br>
      <select name="type" required>
        <option>Bed Types</option>
        <option>Single Bed</option>
        <option>Double Bed</option>
    </select>
 <br><br> 
   <input type="text" name="pid" placeholder="patient Id" required><br><br>

...
%>
      ...
      <div id="content">
         ...
         <h1><font color="blue">Please Take A serial:</font></h1><br>
  <form method="post" action="serialreg.jsp">
      <input type="text" name="fname" placeholder="First Name" required><br><br>
      <input type="text" name="lname" placeholder="Last Name" required><br><br>
      <input type="text" name="email" placeholder="Email" required><br><br>
      <input type="text" name="dname" placeholder="Type Doctors Name" required><br><br>
 <select name="type">
...
<br><br>
    <input type="text" name="mob" placeholder="Type Your Mobile NO" required><br><br>

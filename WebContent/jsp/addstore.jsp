      ...
      <div id="menubar">
        <ul id="menu">
         ...
         <li><a href="adminindex.jsp">Home</a></li>
          ...
          <li class="selected"><a href="addstore.jsp">Add Stores</a></li>
...
%>
      ...
      <div id="content">
         ...
         <h1><font color="blue">Please Add Stores:</font></h1><br>
  <form method="post" action="sregistration.jsp">
    <input type="text" name="mname" placeholder="Medicine Name" required><br><br>
    <input type="text" name="cost" placeholder="Cost(Tk)" required><br><br> 
      <select name="store">
 ...
 <br><br> 
        ...
        <input type="text" name="date" placeholder="Issue Date" required><br><br>

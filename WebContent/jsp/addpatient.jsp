    ...
    <div id="header">
      ...
      <div id="menubar">
        ...
        <li><a href="adminindex.jsp">Home</a></li>
          ...
          <li class="selected"><a href="addpatient.jsp">Add Patient</a></li>
...
%>
      ...
      <div id="content">
         ...
         <h1><font color="blue">Please Add Patient:</font></h1><br>
  <form method="post" action="pregistration.jsp">
    <input type="text" name="pname" placeholder="Patient Name" required><br><br>
      <select name="type">
        <option>Patient Types</option>
        <option>New Patient</option>
        <option>Old Patient</option>
    </select>
 <br><br> 
        <input type="text" name="dname" placeholder="Disease Name" required><br><br> 
        <input type="text" name="adname" placeholder="Appointed Doctors" required><br><br>
        <input type="text" name="mob" placeholder="Patient Contact NO" required><br><br>
